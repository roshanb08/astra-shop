          ...
          <div class="footer-content-left footer-link-wrap">
            ...
            <div class="intro-wrap">
              @if ($footer_content['content']['intro']['logo'] ?? false)
                <div class="logo"><a href="{{ shop_route('home.index') }}"><img src="{{ image_origin($footer_content['content']['intro']['logo']) }}" alt="{{ system_setting('base.meta_title', 'AstraShop') }}" class="img-fluid"></a></div>
              @endif
    ...
    <div class="container-fluid">
      <div class="d-lg-flex align-items-center">
        <div class="text-center d-lg-flex justify-content-center">
          @if(!check_license())
          Powered By&nbsp;<a href="https://astraedtech.com.np" target="_blank" rel="noopener">Astra Edtech</a>&nbsp;-&nbsp;
          @endif
