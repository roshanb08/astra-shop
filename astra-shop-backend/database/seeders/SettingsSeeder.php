...
class SettingsSeeder extends Seeder
{
    ...
    public function getItems()
    {
        return [
            ...
            ["type" => "system", "space" => "base", "name" => "meta_title","value" => "Astra Shop – Powerful Modern E-Commerce Platform", "json" => 0],
            ["type" => "system", "space" => "base", "name" => "meta_description","value" => "Astra Shop is a modern and scalable e-commerce platform designed for businesses of all sizes. It includes advanced product management, order processing, secure payments, customer management, and flexible shipping and tax options.","json" => 0],
            ["type" => "system", "space" => "base", "name" => "meta_keywords","value" => "ecommerce platform, online store, shopping cart, digital store, Astra Shop, product management, business storefront, payment integration","json" => 0],
